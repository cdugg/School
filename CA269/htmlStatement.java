...
class Customer {
    ...
    public String htmlStatement()
    {
        double totalAmount =0;
        int frequent=0;
        String gay="<h1>Statement for " + _name + "</h1>\n<ol>\n";
        for (Rental rental:_rentals){
           
            gay+="  <li>"+rental.getMovie().getTitle()+"  "+String.valueOf(getTotal(rental))+"</li>\n";
           
        }
        gay += "</ol>\n<p>Amount owed is " +String.valueOf(getTotalCharge()) +"</p>\n";
        gay += "<p>You earned " + String.valueOf(getTotalFrequentRenterPoints())+" frequent renter points."+"</p>\n";
        return gay;
    }
